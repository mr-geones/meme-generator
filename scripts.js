...
function showMeme() {
  ...
  const i = document.querySelector("#meme");

  if (i) {
    i.setAttribute("src", randomMemeUrl);
  } else {
    img.id = "meme";
...
function showJoke() {
  ...
  if (p) {
    p.innerHTML = randomJokeText;
  } else {
    para.id = "joke";
    para.innerHTML = randomJokeText;
...
function showQuote() {
  ...
  if (p) {
    p.innerHTML = `${randomQuote.quote} (${randomQuote.author})`;
  } else {
    para.id = "quote";
    para.innerHTML = `${randomQuote.quote} (${randomQuote.author})`;
    content.appendChild(para);
  }
}
...
function showRiddle() {
  ...
  const q = document.querySelector("#riddle");
  const a = document.querySelector("#answer");

  if (q) {
    q.innerHTML = randomRiddle.question;
    a.innerHTML = randomRiddle.answer;
    a.style.display = "none";
  } else {
    question.id = "riddle";
    answer.id = "answer";
    question.innerHTML = randomRiddle.question + "<br>";
    answer.innerHTML = randomRiddle.answer;
